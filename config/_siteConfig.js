...
export default {
  siteName: 'Heimdall',
  tagline: 'A unity project for the DHBW Games class',
  featureImage: '/uploads/home-hero.jpg',
  logo: 'icon.svg', // 'logo-component', // or '/logo.svg' for regular image
  googleAnalytics: {
    on: true,
  ...
  mainMenu: [
    ...
    {
      name: 'Github Repo',
      link: 'https://github.com/Floinker/heimdall',
      target: '_blank'
    }
  ],
  hero: {
  ...
  disqus: {
    ...
    siteShortName: 'heimdall-dhbw' // 'blog-danielkelly-io'
  },
